<?php 
    ...
    if(isset($_POST['lop_id'])) {
    $lop_id=$_POST['lop_id'];
    $sinhvien_count = $sinhvien_model->searchSinhVienByNameClass($search, $lop_id)->rowCount();
    $sinhvien_list = $sinhvien_model->searchSinhVienByNameClass($search, $lop_id);
    }
?>
<?php if ($sinhvien_count==0) { ?>
<p class="text-center text-danger">Không tìm thấy sinh viên.</p>
<?php } else { ?>
<table id="table">
    <tr>
        <th>MSSV</th>
